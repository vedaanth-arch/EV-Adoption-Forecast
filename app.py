...
# === Top black ribbon heading ===
st.markdown("""
    <div style='background-color: #000000; padding: 15px 0px; margin: -1rem -1rem 2rem -1rem; text-align: center;border-radius: 5px;'>
        <div style='font-size: 28px; font-weight: bold; color: #FFFFFF; text-transform: uppercase; letter-spacing: 2px;'>
